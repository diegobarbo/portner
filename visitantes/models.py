...
class Visitante(models.Model):
    ...
    data_nascimento = models.DateField(
        verbose_name="Data de nascimento", auto_now_add=False, auto_now=False
        )
    numero_casa = models.PositiveSmallIntegerField(
        verbose_name="Número da residência a ser visitada"
        )
    ...
    horario_saida = models.DateTimeField(
        verbose_name="Horário de saída do visitante", auto_now=False, blank=True, null=True
        )
    horario_autorizacao = models.DateTimeField(
        verbose_name="Horário de autorização de entrada do visitante", 
        auto_now=False, blank=True, null=True
        )
    morador_responsavel = models.CharField(
        verbose_name="Nome do morador responsável por autorizar a entrada do visitante",
        max_length=194, blank=True
        )
